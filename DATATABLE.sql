CREATE TABLE GraphTable (GraphID INT NOT NULL AUTO_INCREMENT PRIMARY KEY, TableID INT NOT NULL, UserID INT NOT NULL, DateCreated DATETIME NOT NULL, GraphType VARCHAR(255) NOT NULL, Image BLOB);
...
CREATE TABLE TableList (TableID INT NOT NULL AUTO_INCREMENT PRIMARY KEY, TableName VARCHAR(255) NOT NULL, DateCreated DATETIME NOT NULL, UserID INT NOT NULL);
