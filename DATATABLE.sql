...
CREATE TABLE TableList (TableID INT NOT NULL AUTO_INCREMENT PRIMARY KEY, TableName VARCHAR(255) NOT NULL, CreatedBY DATETIME NOT NULL, DateCreated DATETIME NOT NULL, CreatedFrom INT NOT NULL);
