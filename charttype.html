...
<body style="background-image: url('images/visualise-home-banners-1871x550-.png');background-position:right top;background-size:auto 100%;background-repeat: no-repeat; ">
</body>
