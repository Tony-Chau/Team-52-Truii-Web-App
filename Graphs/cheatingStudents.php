    ...
    <div class= "container">
      ...
      <script>
        ...
        var trace1 = {
          ...
          type: 'scatter',
          name: 'Year 2000',
          text: ['Number of Students Caught During Term 1', 'Number of Students Caught During Term 2', 'Number of Students Caught During  3', 'Number of Students Caught During Term 4']
        };
